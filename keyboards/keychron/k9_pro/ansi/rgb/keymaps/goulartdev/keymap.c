...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_61_ansi(
        ...
        LT(FN1, CW_TOGG), KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,            KC_ENT,
        KC_LSFT,          KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,                      KC_RSFT,
        KC_LCTL,          KC_LALT,  KC_LGUI,                                LT(FN, KC_SPC),                         KC_RGUI,  TT(FN),  MO(FN1),   KC_ALGR),
    ...
    [FN] = LAYOUT_61_ansi(
        ...
        _______,  _______,  KC_BSPC,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,                     _______,
        _______,  _______,  _______,                                _______,                                _______,  TT(BASE), _______, _______),
