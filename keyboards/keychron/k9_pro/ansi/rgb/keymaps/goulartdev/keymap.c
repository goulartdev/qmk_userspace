...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LT(FN1, KC_CAPS),  A_GUI,    S_ALT,    D_SFT,    F_CTL,    KC_G,     KC_H,     J_CTL,    K_SFT,    L_ALT,    SCLN_GUI, KC_QUOT,            KC_ENT,
    ...
    [FN1] = LAYOUT_61_ansi(
        ...
        _______,       RGB_MOD,  RGB_VAI,  RGB_HUI,  RGB_SAI,  RGB_SPI,  KC_MS_L,  KC_MS_D,  KC_MS_U,  KC_MS_R,  XXXXXXX,  XXXXXXX,            _______,
